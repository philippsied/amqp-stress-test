...
Werden im Transaktionsmodus zu viele Producer angelegt, welche ihre Nachrichten nicht committen, kam es sporadisch zu einen Ausfall des Servers. Selbst die Weboberfläche konnte nicht mehr erreicht werden. Nach einiger Zeit löst der Server dennoch die Verbindungen wieder auf und ist anschließend wieder erreichbar. 
