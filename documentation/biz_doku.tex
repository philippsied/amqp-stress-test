...
\section*{Beschreibung des Benchmarking}
	...
	\usecase{Leerlauf}%
		...
		{Keine}%
		{%
		 \measure{CPU}{\textasciitilde 0.7\%}\\
		 \measure{RAM}{11.1\% (110MB)}\\
		 \measure{HDD}{5.01GB/5.78GB}\\
		 \measure{NET}{IN \textasciitilde 3Kbit/s\quad OUT \textasciitilde 197Kbit/s}%
		}%
		{Keine}
	
	\usecase{Referenzszenario}%
		...
		{%
		 \measure{CPU}{\textasciitilde 3.8\%}\\
		 \measure{RAM}{11.4\% (113MB)}\\
		 \measure{HDD}{5.01GB/5.78GB}\\
		 \measure{NET}{IN \textasciitilde 476Kbit/s\quad OUT \textasciitilde 582Kbit/s}%
		}%
...
\section*{Beschreibung der Angriffe}
	...
	\attack{Referenzangriff - Kooperativer Client}%
		...
		{%
		 \measure{CPU}{\textasciitilde 10.1\% - 13.0\%}\\
		 \measure{RAM}{11.9\% - 12.0\% (118MB - 119MB)}\\
		 \measure{HDD}{5.01GB/5.78GB}\\
		 \measure{NET}{IN \textasciitilde 8.51Mbit/s\quad OUT \textasciitilde 66.67Mbit/s}%
		}%
...
\clearpage
	\attack{Ignorieren von Nachrichten}%
		...
		{%
		 \measure{CPU}{\textasciitilde 11.1\% - 38.7\%}\\
		 \measure{RAM}{12.0\% - 12.0\% (120MB - 386MB)}\\
		 \measure{HDD}{5.01GB/5.78GB bis 5.42GB/5.78GB}\\
		 \measure{NET}{IN \textasciitilde 8.33Mbit/s\quad OUT \textasciitilde 68.0Mbit/s}%
		}%
